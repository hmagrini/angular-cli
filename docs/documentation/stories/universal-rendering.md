...
As your application grows you will notice that the total build time will increase
rapidly, as the current setup would first run the "browser" build and will wait
